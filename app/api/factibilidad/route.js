  ...
  try {
    await sql`
      INSERT INTO factibilidad (
        ...
        consumo_mensual_kwh, monto_mensual_pago, tipo_sistema, respaldo_baterias, tipo_instalacion,
        ideal_kw, plan_elegido_kw, sub_opcion_elegida, paneles_cantidad, strings_cantidad,
